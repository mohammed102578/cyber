...
class Chatbox extends Component
{
    ...
    public function  getListeners()
    {
        ...
        return [
            "echo-private:admin_chat.{$auth_id},MessageSent" => 'broadcastedMessageReceived',
            "echo-private:admin_chat.{$auth_id},MessageRead" => 'broadcastedMessageRead',
...
//dd($this->messages[0]['conversation_id']);
       ...
       $aa= Message::where('conversation_id',$this->selectedConversation->id)
         ->where('receiver_id',auth()->user('admin')->id)->where('receiver_type','admin')->update(['read'=> 1]);
    ...
    {
        return view('livewire.admin.chat.chatbox')->layout('layouts.admin.app');
    }
}
