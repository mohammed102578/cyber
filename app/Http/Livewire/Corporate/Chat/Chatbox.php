...
class Chatbox extends Component
{
    ...
    public function  getListeners()
    {
        ...
        return [
            "echo-private:corporate_chat.{$auth_id},MessageSent" => 'broadcastedMessageReceived',
            "echo-private:corporate_chat.{$auth_id},MessageRead" => 'broadcastedMessageRead',
...
//dd($this->messages[0]['conversation_id']);
       ...
       $aa= Message::where('conversation_id',$this->selectedConversation->id)
         ->where('receiver_id',auth()->user('corporate')->id)->where('receiver_type','corporate')->update(['read'=> 1]);
    ...
    {
        return view('livewire.corporate.chat.chatbox')->layout('layouts.corporate.app');
    }
}
