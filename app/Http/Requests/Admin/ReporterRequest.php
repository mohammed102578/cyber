...
class ReporterRequest extends FormRequest
{
     ...
     */
     ...
     public function rules()
     {
         ...
         return [
             'email' => 'required|email:rfc,dns|unique:reporters,email,'.$this->id,
             'phone' => 'required|min:9|unique:reporters,phone,'.$this->id,
     ...
     public function messages()
     {
         return [
             ...
             'phone.min' => 'The field must contain at least ten characters.',
